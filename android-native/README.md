...
The Play update keeps the existing package ID `online.alarabiya.store` and starts the native line at
`versionCode 3`. A signed production build reads these values from environment variables or Gradle
