export const STOREFRONT_SHELL_CHUNK_GLOB =
  "assets/{Storefront,framework,data-client,ui-vendor,icons,observability,offline-store,charts,motion,onlineOrderStatus,money,governorates,whatsapp,TurnstileWidget,IntlPhoneInput,date,invoiceStatus,intlPhone,numberNormalize,storefrontSearchNormalize}-*.js";
