...
/** زر "إرسال واتساب" — يفتح wa.me بالرسالة جاهزة (المستخدم يضغط إرسال مرة واحدة) */
export function WhatsAppShare({ phone, message, label = "إرسال واتساب", size = "sm", className }: Props) {
  return (
    <Button
      variant="outline"
      size={size}
