...
export function StorefrontThematicGrid({
  ...
  // إذا كانت البيانات قيد التحميل لأول مرة ولم تتوفر كاش، نعرض هيكلاً شكلياً ناعماً (Skeleton)
  ...
  // قاعدة الصفر تشكيلات فارغة: إذا لم يتوفر أي نمط بمنتجات حقيقية، نخفي القسم بالكامل
          ...
          return (
            ...
            >
              ...
              <div className="mt-6 pt-4 border-t border-white/10">
                <div
                  className="inline-flex w-full items-center justify-between rounded-xl bg-white/10 px-4 py-2.5 text-xs font-black text-white transition group-hover:bg-white group-hover:text-slate-950"
                >
