...
import { BannerFrame } from "@/components/store/BannerFrame";

interface StorefrontHeroProps {
  heroBanners?: any[];
  featuredHero?: any | null;
...
export function StorefrontHero({
  ...
  return (
    <section
      aria-label="الواجهة الترويجية للمتجر"
      className="relative mb-8 grid min-h-[460px] grid-cols-1 overflow-hidden rounded-3xl border border-amber-900/20 bg-gradient-to-br from-stone-900 via-stone-900 to-amber-950 text-white shadow-2xl lg:grid-cols-2"
    >
      ...
      <div className="relative z-10 flex flex-col justify-center p-7 sm:p-10 lg:p-12">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3.5">
          <button
            ...
            className="group flex items-center gap-2.5 rounded-2xl bg-gradient-to-l from-orange-600 to-amber-600 px-7 py-4 text-sm font-black text-white shadow-xl shadow-orange-600/25 transition-all duration-200 hover:from-orange-500 hover:to-amber-500 hover:shadow-orange-600/40 active:scale-95 cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-2xl border border-white/20 bg-white/10 px-6 py-4 text-sm font-bold text-white backdrop-blur-md transition-all duration-200 hover:bg-white/20 active:scale-95 cursor-pointer"
          >
        ...
        {bannerCarouselComponent ? (
          ...
          <div className="relative flex size-full flex-col justify-between overflow-hidden rounded-3xl border border-white/15 bg-gradient-to-br from-stone-900/90 via-slate-900/95 to-stone-950 p-6 sm:p-8 text-white shadow-2xl backdrop-blur-md">
            ...
            <button
              type="button"
              onClick={onExplorePicks}
              className="relative z-10 group flex w-full items-center justify-between rounded-2xl border border-white/20 bg-white/10 px-5 py-3.5 text-xs font-black text-white transition hover:bg-white/20 active:scale-95 cursor-pointer"
            >
