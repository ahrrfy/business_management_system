...
const CashRemediation = lazy(() => import("@/pages/CashRemediation"));
...
export default function App() {
  return (
    ...
    <Switch>
      ...
      <Route path="/announcements"><Shell><RequireRole roles={["admin","manager"]}><Announcements /></RequireRole></Shell></Route>
