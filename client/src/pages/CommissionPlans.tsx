      ...
      <Card>
        <CardHeader>
          <ListToolbar
            ...
            search={{ value: query, onChange: setQuery, placeholder: "اسم الخطة، النمط، الشرائح أو الملاحظات…" }}
            ...
            exportSpec={{
              ...
              columns: [
                ...
                { key: "tierMode", header: "النمط", map: (p) => MODE_LABEL[p.tierMode] },
                { key: "tiers", header: "الشرائح", map: (p) => tierSummary(p) },
                { key: "openAssignments", header: "الإسنادات" },
