...
export default function ARAging() {
  ...
  // مَسح التَحديد عِند تَغَيُّر فِلتَر الفَرع — وَإلّا يَبقى sel.count يَحوي customerIds
          ...
          <table className="w-full text-sm">
            <thead className="bg-muted/50">
              <tr className="text-end">
                ...
                <th className="p-2 text-start">الرصيد (لنا عليه)</th>
            ...
            <tbody>
              ...
              {aging.data && aging.data.length === 0 && (
                <tr><td colSpan={13} className="p-6 text-center text-muted-foreground">لا ذمم مستحقّة. ممتاز.</td></tr>
              )}
            </tbody>
          </table>
        </CardContent>
