...
// مرآة reportViewerProcedure: لا اعتماد على managerOnly ولا على قالب reports العاري.
...
const TABS: HubTab[] = [
  ...
  { value: "statement", label: "كشف حساب مورد", gate: REPORT_VIEWER_GATE, Component: SupplierStatement },
  { value: "aging", label: "أعمار الذمم (دائنة)", gate: REPORT_VIEWER_GATE, Component: APAging },
];
