...
const TABS:HubTab[]=[
  ...
  {value:"collections",label:"التحصيل والمتأخرات",gate:{module:"collections",level:"READ"},Component:ARReminders},
  {value:"installments",label:"الأقساط",gate:{module:"collections",level:"READ"},Component:InstallmentPlans},
