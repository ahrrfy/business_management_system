...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "تدقيق شذوذ الكتالوج", desc: "٦ عدسات تكشف بيانات مغلوطة (تكلفة/سعر/معامل)، مع أفعال إصلاح/قصديّ/تجاهل", href: "/reports/catalog-anomalies", icon: AlertTriangle, gate: "manager", status: "ready" },
