...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    icon: ShoppingCart,
    items: [
      { title: "تقرير المبيعات", desc: "فواتير + أكثر مبيعاً + بطيئة + ربح حسب الفئة", href: "/sales-report", icon: Receipt, gate: "manager", status: "ready" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "أعمار الذمم المدينة", desc: "0-30 / 31-60 / 61-90 / +90 يوم", href: "/ar-aging", icon: Hourglass, gate: "manager", status: "ready" },
