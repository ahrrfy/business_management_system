...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "تدقيق شذوذ الكتالوج", desc: "٧ عدسات تكشف بيانات مغلوطة (تكلفة/سعر/معامل/بلا سعر قائمة)، مع أفعال إصلاح/قصديّ/تجاهل", href: "/reports/catalog-anomalies", icon: AlertTriangle, gate: "manager", status: "ready" },
