...
export const PRODUCT_FIELDS: ImportField<ProductImportRow>[] = [
  ...
  },
  {
    ...
    example: "12",
    // سياسة القيم الشاذة (منصوصة): السالب يُقصّ صفراً مع تحذير؛ الكسري الحقيقي يفشل (يبتلع integer النقطةَ الزائدة «4.»).
    clampNegativeToZero: true,
    clampWarning: "رصيد سالب في النظام القديم — استُورد صفراً، سوِّه من شاشة الجرد",
  },
];
