...
// (شعار + مكتبة العربية + Code128 + جدول المنتجات + الإجماليات + التواصل + سياسة الاستبدال)
...
// أعمدة جدول المنتجات (RTL كقالب HTML): المنتج يميناً ← عدد ← السعر ← المبلغ أقصى اليسار
