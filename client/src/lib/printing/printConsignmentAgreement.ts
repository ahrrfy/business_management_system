...
function clauses(input: ConsignmentAgreementInput): string[] {
  ...
  return [
    "البضاعة المودَعة تبقى <b>ملكاً للمودِع</b> حتى لحظة بيعها للعميل؛ لا ينشأ أيّ دين على المكتبة عند الاستلام.",
    "تُحدَّد <b>حصة المودِع</b> من ثمن كل منتج على حدة في سندات الإيداع الموقَّعة من الطرفين، وتستحقّ عند بيع القطعة.",
    "تعديل حصة أيّ منتج يسري على <b>المبيعات المقبلة فقط</b>؛ المبيعات السابقة محفوظة بقيمتها وقت البيع.",
