...
//  • **ديناميكيّ على طول اسم المنتج** — حجم خطّ الاسم يتكيّف مع طوله حتى يظهر كاملاً واضحاً
...
/**
 * حجم خطّ اسم المنتج (نقطة) متكيّفاً مع طوله وعرض الملصق: الأسماء القصيرة كبيرة وبارزة،
 ...
 * تُحسَب لكلّ منتج حسب طول اسمه. التخطيط: [اسم اختياري] ← [قضبان Code128 بارتفاعٍ محسوب يفسح
