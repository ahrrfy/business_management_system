...
تُنجز شريحةً واحدة من الصفر إلى ١٠٠٪ وفق القاعدة الحاكمة (AGENTS.md §٤): **خلفية + واجهة + `pnpm check` + تحقّق + ظهور في التنقّل = ١٠٠٪**. تتعاون إلزامياً مع نظام التنسيق (`scripts/coord.mjs`) كي لا تصطدم جلستان.
...
من وسيط المستخدم أو من «الخطوة التالية المقترحة» في AGENTS.md §٦. كوّن:
```
