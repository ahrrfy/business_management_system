...
/**
 * المسار الأول (قرار المالك ٢٤/٩/٢٦): سند القبض العادي محرر بالكامل من أي استبقاء موروث.
 * النقد يُقيد فوراً في وردية ودرج الكاشير المستلم الحقيقي لحظة الإنشاء،
 * والاعتماد الإلزامي محصور في خروج المال (MONEY_OUT) ومحو الأثر (ERASE_EFFECT).
 */
