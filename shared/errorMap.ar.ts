...
export const UNIQUE_AR: Record<string, UniqueInfo> = {
  ...
  uq_costwave_item_variant: { msg: "الصنف مُدرَج مسبقاً في موجة التكلفة نفسها — أعد إنشاء المعاينة قبل الإرسال." },
  uq_costwave_approval_actor: { msg: "قرار هذا المعتمد مسجّل مسبقاً للموجة — يلزم معتمد آخر مختلف لإكمال الاعتمادين." },
