...
const TABLE_AR: Record<string, string> = {
  ...
  goodsReceipts: "أذونات الاستلام المخزني",
  goodsReceiptItems: "بنود أذونات الاستلام",
  goodsReceiptReversals: "مستندات عكس الاستلام",
  supplierInvoices: "فواتير الموردين",
  supplierInvoiceDraftRevisions: "مراجعات مسودات فواتير الموردين",
  supplierInvoiceLines: "بنود فواتير الموردين",
  purchaseReturnRequests: "طلبات مرتجع الشراء",
  purchaseReturnRequestItems: "بنود طلبات مرتجع الشراء",
  purchaseReturnReversalRequests: "طلبات عكس مرتجع الشراء",
  purchaseReturnReversals: "مستندات عكس مرتجع الشراء",
  supplierPaymentRequests: "طلبات سداد الموردين",
  supplierPaymentRequestAllocations: "تخصيصات طلبات سداد الموردين",
  legacySupplierInvoiceSettlements: "أدلة التسوية الإرثية لفواتير الموردين",
  supplierPayments: "دفعات الموردين",
  supplierPaymentAllocations: "تخصيصات دفعات الموردين",
  supplierPaymentRefundRequests: "طلبات استرداد دفعات الموردين",
  supplierPaymentRefunds: "استردادات دفعات الموردين",
  purchaseCharges: "مصروفات الشراء",
  purchaseChargeAllocations: "تخصيصات مصروفات الشراء",
  purchaseIntegrityCases: "قضايا نزاهة الشراء",
  purchaseIntegrityCaseEvents: "أحداث قضايا نزاهة الشراء",
  deliveryCodWriteOffRequests: "طلبات شطب عجز عهدة التوصيل",
  commissionRunApprovalRequests: "طلبات اعتماد تشغيلات العمولات",
  salesLeads: "العملاء المحتملون",
  salesLeadEvents: "أحداث العملاء المحتملين",
  salesOpportunities: "فرص المبيعات",
  salesOpportunityEvents: "أحداث فرص المبيعات",
  salesControlRequests: "طلبات التحكم بفواتير المبيعات",
  salesExchangeCommands: "أوامر استبدال فواتير المبيعات",
  ...
  cashMissedDailyCountExceptions: "استثناءات الجرد النقدي اليومي المفقود",
  cashMissedDailyCountExceptionEvents: "أحداث استثناءات الجرد النقدي اليومي المفقود",
};
...
export const UNIQUE_AR: Record<string, UniqueInfo> = {
  ...
  uq_instplan_active_invoice: { msg: "توجد خطة أقساط نشطة لهذه الفاتورة — أغلقها أو أكملها قبل إنشاء خطة أخرى." },
  ...
  storefrontPushCampaigns_eventKey_unique: {
    msg: "تحديث العميل هذا مسجّل مسبقاً — لم يُنشأ إشعار متجر مكرّر.",
  },
  ...
  workOrderControlRequests_requestKey_unique: {
    msg: "طلب التحكم هذا مسجّل مسبقاً — أعد فتح الطلب القائم بدل إنشاء قرارٍ مكرّر.",
  },
  workOrderDesignApprovals_requestKey_unique: {
    msg: "طلب اعتماد نسخة التصميم مسجّل مسبقاً — افتح الطلب القائم بدل إنشاء نسخة قرار مكررة.",
  },
  workOrderDesignApprovals_decisionKey_unique: {
    msg: "قرار اعتماد التصميم سبق تسجيله — أعد تحميل نتيجته بدل إنشاء قرار ثانٍ.",
  },
  uq_wom_one_base_material: {
    msg: "المادة الأساس لأمر الشغل مسجّلة مسبقاً — حدّث السطر القائم ولا تُنشئ مادة أساس ثانية.",
  },
  uq_wo_design_revision: {
    msg: "رقم نسخة التصميم مستخدم لهذا الأمر — أعد تحميل النسخة الحالية قبل الحفظ.",
  },
  uq_wo_design_approval_revision: {
    msg: "لهذه النسخة طلب اعتماد قائم أو محسوم — لا يُنشأ طلب ثانٍ للنسخة نفسها.",
  },
  uq_po_current_revision: { msg: "نسخة أمر الشراء الحالية مرتبطة بأمر آخر — أعد تحميل الأمر." },
  uq_po_approved_revision: { msg: "نسخة أمر الشراء المعتمدة مرتبطة بأمر آخر — أعد تحميل الأمر." },
  uq_po_revision_no: { msg: "رقم مراجعة أمر الشراء مستخدم مسبقاً — أعد تحميل سجل المراجعات." },
  uq_po_revision_hash: { msg: "محتوى مراجعة أمر الشراء محفوظ مسبقاً — لا حاجة لإنشاء نسخة مطابقة." },
  uq_po_revision_line: { msg: "رقم بند مراجعة أمر الشراء مكرر داخل النسخة." },
  uq_po_control_request_key: { msg: "طلب التحكم بأمر الشراء مسجل مسبقاً — افتح الطلب القائم." },
  uq_po_control_pending: { msg: "يوجد طلب تحكم معلّق من النوع نفسه لهذا الأمر." },
  uq_po_event_key: { msg: "حدث أمر الشراء مسجل مسبقاً — أعد تحميل سجل الأحداث." },
  uq_po_event_hash: { msg: "بصمة حدث أمر الشراء مسجلة مسبقاً." },
  uq_purchase_req_number: { msg: "رقم طلب الشراء مستخدم مسبقاً." },
  uq_purchase_req_line: { msg: "رقم بند طلب الشراء مكرر داخل الطلب." },
  uq_purchase_req_control_request_key: { msg: "طلب اعتماد طلب الشراء مسجل مسبقاً — افتح الطلب القائم." },
  uq_purchase_req_control_pending: { msg: "يوجد قرار معلّق من النوع نفسه لطلب الشراء." },
  uq_po_req_allocation_pair: { msg: "هذا البند موزع مسبقاً على بند طلب الشراء نفسه." },
  // ── الاستلام المخزني / GRNI / فواتير المورد والمطابقة الثلاثية (0301–0302) ──
  uq_goods_receipt_number: { msg: "رقم إذن الاستلام مستخدم مسبقاً — أعد المحاولة لتوليد رقم جديد." },
  uq_goods_receipt_request: { msg: "طلب الاستلام مسجل مسبقاً — افتح إذن الاستلام القائم." },
  uq_goods_receipt_request_hash: { msg: "بصمة طلب الاستلام مسجلة مسبقاً لهذا المفتاح." },
  uq_goods_receipt_inventory_movement: { msg: "حركة المخزون مرتبطة ببند استلام آخر — راجع الإذن المسجل." },
  uq_goods_receipt_line: { msg: "رقم بند الاستلام مكرر داخل الإذن نفسه." },
  uq_goods_receipt_order_item: { msg: "بند أمر الشراء مضاف مسبقاً إلى إذن الاستلام نفسه." },
  uq_grn_reversal_request_key: { msg: "طلب عكس الاستلام مسجل مسبقاً — افتح الطلب القائم." },
  uq_grn_reversal_pending: { msg: "يوجد طلب عكس معلّق لإذن الاستلام نفسه." },
  uq_grn_reversal_decision_key: { msg: "قرار عكس الاستلام مسجل مسبقاً — أعد تحميل نتيجته." },
  uq_grn_reversal_request_item: { msg: "بند الاستلام مكرر داخل طلب العكس." },
  uq_grn_reversal_number: { msg: "رقم مستند عكس الاستلام مستخدم مسبقاً — أعد المحاولة." },
  uq_grn_reversal_request: { msg: "طلب عكس الاستلام نُفذ مسبقاً بمستند عكس." },
  uq_grn_reversal_hash: { msg: "بصمة مستند عكس الاستلام مسجلة مسبقاً." },
  uq_grn_reversal_inventory_movement: { msg: "حركة المخزون مرتبطة ببند عكس استلام آخر." },
  uq_grn_reversal_item: { msg: "بند الاستلام معكوس مسبقاً داخل مستند العكس نفسه." },
  uq_grn_accounting_link_key: { msg: "رابط قيد الاستلام المحاسبي مسجل مسبقاً." },
  uq_grn_accounting_entry: { msg: "القيد المحاسبي مرتبط بإذن استلام أو عكس آخر." },
  uq_supplier_invoice_number: { msg: "رقم فاتورة المورد الداخلي مستخدم مسبقاً — أعد المحاولة." },
  uq_supplier_invoice_request: { msg: "طلب تسجيل فاتورة المورد مسجل مسبقاً — افتح الفاتورة القائمة." },
  uq_supplier_invoice_posting_entry: { msg: "قيد ترحيل فاتورة المورد مرتبط بفاتورة أخرى." },
  uq_supplier_invoice_reversal_entry: { msg: "قيد عكس فاتورة المورد مرتبط بفاتورة أخرى." },
  uq_supplier_invoice_external: { msg: "رقم فاتورة المورد مسجل مسبقاً لهذا المورد — افتح الفاتورة القائمة." },
  uq_supplier_invoice_request_hash: { msg: "بصمة فاتورة المورد مسجلة مسبقاً لهذا الطلب." },
  uq_supplier_invoice_line: { msg: "رقم بند فاتورة المورد مكرر داخل الفاتورة." },
  uq_supplier_invoice_match_key: { msg: "تشغيل المطابقة الثلاثية مسجل مسبقاً — افتح النتيجة القائمة." },
  uq_supplier_invoice_match_run: { msg: "رقم تشغيل المطابقة مستخدم مسبقاً لهذه الفاتورة — أعد تحميل سجل المطابقات." },
  uq_supplier_invoice_match_evidence: { msg: "لقطة المطابقة نفسها فُحصت مسبقاً لهذه الفاتورة." },
  uq_supplier_invoice_match_allocation: { msg: "هذا الربط الثلاثي بين الفاتورة والاستلام مكرر داخل التشغيل." },
  uq_supplier_invoice_approval_request: { msg: "طلب اعتماد فاتورة المورد مسجل مسبقاً — افتح الطلب القائم." },
  uq_supplier_invoice_approval_pending: { msg: "يوجد طلب اعتماد معلّق من النوع نفسه لهذه الفاتورة." },
  uq_supplier_invoice_approval_decision: { msg: "قرار اعتماد فاتورة المورد مسجل مسبقاً — أعد تحميل نتيجته." },
  // ── مرتجع الشراء الموثق وعكسه (0303) ──
  uq_purchase_return_request_key: { msg: "طلب مرتجع الشراء مسجل مسبقاً — افتح الطلب القائم." },
  uq_purchase_return_pending: { msg: "يوجد طلب مرتجع معلّق للمصدر نفسه." },
  uq_purchase_return_decision: { msg: "قرار طلب مرتجع الشراء مسجل مسبقاً — أعد تحميل نتيجته." },
  uq_purchase_return_request_evidence: { msg: "دليل المرتجع نفسه مرتبط بهذه الفاتورة مسبقاً." },
  uq_purchase_return_request_line: { msg: "رقم بند طلب المرتجع مكرر داخل الطلب." },
  uq_purchase_return_request_allocation: { msg: "تخصيص المطابقة هذا مضاف مسبقاً إلى طلب المرتجع." },
  uq_purchase_return_request_source: { msg: "مصدر بند المرتجع نفسه مكرر داخل الطلب." },
  uq_purchase_return_request: { msg: "طلب المرتجع نُفذ مسبقاً بمستند مرتجع." },
  uq_purchase_return_cash_receipt: { msg: "إيصال استرداد المورد مرتبط بمرتجع شراء آخر." },
  uq_purchase_return_inventory_movement: { msg: "حركة المخزون مرتبطة ببند مرتجع شراء آخر." },
  uq_purchase_return_reversal_request_key: { msg: "طلب عكس مرتجع الشراء مسجل مسبقاً." },
  uq_purchase_return_reversal_pending: { msg: "يوجد طلب عكس معلّق لهذا المرتجع." },
  uq_purchase_return_reversal_decision: { msg: "قرار عكس مرتجع الشراء مسجل مسبقاً." },
  uq_purchase_return_reversal_req_item: { msg: "بند المرتجع مكرر داخل طلب العكس." },
  uq_purchase_return_reversal_number: { msg: "رقم مستند عكس المرتجع مستخدم مسبقاً." },
  uq_purchase_return_reversal_request: { msg: "طلب عكس المرتجع نُفذ مسبقاً." },
  uq_purchase_return_reversal_entry: { msg: "قيد عكس المرتجع مرتبط بمستند آخر." },
  uq_purchase_return_reversal_receipt: { msg: "إيصال رد مبلغ العكس مرتبط بمستند آخر." },
  uq_purchase_return_reversal_hash: { msg: "بصمة مستند عكس المرتجع مسجلة مسبقاً." },
  uq_purchase_return_reversal_movement: { msg: "حركة المخزون مرتبطة ببند عكس مرتجع آخر." },
  uq_purchase_return_reversal_item: { msg: "بند المرتجع مكرر داخل مستند العكس." },
  // ── سداد فواتير المورد وتخصيصاته واسترداده (0304) ──
  uq_supplier_payment_request_key: { msg: "طلب سداد المورد مسجل مسبقاً — افتح الطلب القائم." },
  uq_legacy_supplier_settlement_entry: { msg: "قيد التسوية الإرثي مرتبط مسبقاً بفاتورة مورد محددة." },
  uq_legacy_supplier_settlement_evidence: { msg: "دليل التسوية الإرثي نفسه مسجل مسبقاً." },
  uq_supplier_invoice_draft_revision_no: { msg: "رقم مراجعة مسودة فاتورة المورد مستخدم مسبقاً." },
  uq_supplier_invoice_draft_revision_version: { msg: "هذه النسخة من مسودة فاتورة المورد محفوظة مسبقاً." },
  uq_supplier_invoice_draft_request_key: { msg: "طلب تعديل مسودة فاتورة المورد مسجل مسبقاً." },
  uq_supplier_payment_pending: { msg: "يوجد طلب سداد معلّق للمجموعة نفسها من فواتير المورد." },
  uq_supplier_payment_decision: { msg: "قرار سداد المورد مسجل مسبقاً — أعد تحميل نتيجته." },
  uq_supplier_payment_request_evidence: { msg: "دليل السداد نفسه مسجل مسبقاً لهذا المورد." },
  uq_supplier_payment_req_invoice: { msg: "فاتورة المورد مخصصة مسبقاً داخل طلب السداد نفسه." },
  uq_supplier_payment_active_invoice: { msg: "توجد مطالبة سداد حية لهذه الفاتورة — احسم الطلب القائم قبل إنشاء طلب آخر." },
  uq_supplier_payment_number: { msg: "رقم دفعة المورد مستخدم مسبقاً." },
  uq_supplier_payment_request: { msg: "طلب السداد نُفذ مسبقاً بدفعة مورد." },
  uq_supplier_payment_receipt: { msg: "سند صرف المورد مرتبط بدفعة أخرى." },
  uq_supplier_payment_entry: { msg: "قيد سداد المورد مرتبط بدفعة أخرى." },
  uq_supplier_payment_hash: { msg: "بصمة دفعة المورد مسجلة مسبقاً." },
  uq_supplier_payment_request_allocation: { msg: "تخصيص الطلب نُفذ مسبقاً ضمن دفعة مورد." },
  uq_supplier_payment_allocation_invoice: { msg: "فاتورة المورد مخصصة مسبقاً داخل الدفعة نفسها." },
  uq_supplier_payment_refund_request_key: { msg: "طلب استرداد دفعة المورد مسجل مسبقاً." },
  uq_supplier_payment_refund_pending: { msg: "يوجد طلب استرداد معلّق لهذه الدفعة." },
  uq_supplier_payment_refund_decision: { msg: "قرار استرداد دفعة المورد مسجل مسبقاً." },
  uq_supplier_payment_refund_req_alloc: { msg: "تخصيص الدفعة مكرر داخل طلب الاسترداد." },
  uq_supplier_payment_refund_number: { msg: "رقم استرداد دفعة المورد مستخدم مسبقاً." },
  uq_supplier_payment_refund_request: { msg: "طلب الاسترداد نُفذ مسبقاً." },
  uq_supplier_payment_refund_receipt: { msg: "إيصال استرداد دفعة المورد مرتبط بمستند آخر." },
  uq_supplier_payment_refund_entry: { msg: "قيد استرداد دفعة المورد مرتبط بمستند آخر." },
  uq_supplier_payment_refund_hash: { msg: "بصمة استرداد دفعة المورد مسجلة مسبقاً." },
  uq_supplier_payment_refund_allocation: { msg: "تخصيص الدفعة مكرر داخل مستند الاسترداد." },
  // ── مصروفات الشراء (0305) ──
  uq_purchase_charge_number: { msg: "رقم مصروف الشراء مستخدم مسبقاً." },
  uq_purchase_charge_request: { msg: "طلب إنشاء مصروف الشراء مسجل مسبقاً." },
  uq_purchase_charge_posting_entry: { msg: "قيد مصروف الشراء مرتبط بمستند آخر." },
  uq_purchase_charge_payment_receipt: { msg: "إيصال دفع المصروف مرتبط بمستند آخر." },
  uq_purchase_charge_reversal_entry: { msg: "قيد عكس المصروف مرتبط بمستند آخر." },
  uq_purchase_charge_reversal_receipt: { msg: "إيصال عكس المصروف مرتبط بمستند آخر." },
  uq_purchase_charge_evidence: { msg: "دليل مصروف الشراء نفسه مسجل مسبقاً لهذا الطرف." },
  uq_purchase_charge_allocation_line: { msg: "رقم تخصيص المصروف مكرر داخل المستند." },
  uq_purchase_charge_allocation_source: { msg: "مصدر تخصيص المصروف مكرر داخل المستند." },
  uq_purchase_charge_control_request: { msg: "طلب التحكم بمصروف الشراء مسجل مسبقاً." },
  uq_purchase_charge_control_pending: { msg: "يوجد طلب تحكم معلّق لهذا المصروف." },
  uq_purchase_charge_control_decision: { msg: "قرار التحكم بمصروف الشراء مسجل مسبقاً." },
  // ── قضايا نزاهة الشراء (0306) ──
  uq_purchase_integrity_case_number: { msg: "رقم قضية نزاهة الشراء مستخدم مسبقاً." },
  uq_purchase_integrity_case_key: { msg: "قضية نزاهة الشراء لهذه الواقعة مسجلة مسبقاً." },
  uq_purchase_integrity_open_guard: { msg: "توجد قضية نزاهة مفتوحة لهذه الواقعة." },
  uq_purchase_integrity_resolution_request: { msg: "طلب حل قضية النزاهة مسجل مسبقاً." },
  uq_purchase_integrity_resolution_pending: { msg: "يوجد طلب حل معلّق لهذه القضية." },
  uq_purchase_integrity_resolution_decision: { msg: "قرار حل قضية النزاهة مسجل مسبقاً." },
  uq_purchase_integrity_case_evidence: { msg: "دليل قضية النزاهة نفسه مسجل مسبقاً." },
  uq_purchase_integrity_event_key: { msg: "حدث قضية نزاهة الشراء مسجل مسبقاً." },
  uq_purchase_integrity_event_hash: { msg: "بصمة حدث قضية النزاهة مسجلة مسبقاً." },
  // ── حوكمة COD والعمولات ومسار المبيعات (0309–0313) ──
  uq_delivery_cod_writeoff_request_key: { msg: "طلب شطب عجز التوصيل مسجل مسبقاً — افتح الطلب القائم." },
  uq_delivery_cod_writeoff_pending: { msg: "يوجد طلب شطب عجز معلّق لهذه الجهة." },
  uq_delivery_cod_writeoff_decision: { msg: "قرار شطب عجز التوصيل مسجل مسبقاً — أعد تحميل النتيجة." },
  uq_commission_run_approval_request_key: { msg: "طلب اعتماد تشغيلة العمولات مسجل مسبقاً." },
  uq_commission_run_approval_pending: { msg: "يوجد طلب اعتماد معلّق لهذه التشغيلة والنطاق." },
  uq_commission_run_approval_decision: { msg: "قرار اعتماد تشغيلة العمولات مسجل مسبقاً." },
  uq_sales_lead_number: { msg: "رقم العميل المحتمل مستخدم مسبقاً." },
  uq_sales_lead_create_key: { msg: "طلب إنشاء العميل المحتمل مسجل مسبقاً — افتح السجل القائم." },
  uq_sales_lead_event_key: { msg: "حدث العميل المحتمل مسجل مسبقاً." },
  uq_sales_opp_number: { msg: "رقم فرصة المبيعات مستخدم مسبقاً." },
  uq_sales_opp_create_key: { msg: "طلب إنشاء فرصة المبيعات مسجل مسبقاً." },
  uq_sales_opp_lead: { msg: "هذا العميل المحتمل مرتبط بفرصة مبيعات بالفعل." },
  uq_sales_opp_quotation: { msg: "عرض السعر مرتبط بفرصة مبيعات أخرى." },
  uq_sales_opp_invoice: { msg: "الفاتورة مرتبطة بفرصة مبيعات أخرى." },
  uq_sales_opp_event_key: { msg: "حدث فرصة المبيعات مسجل مسبقاً." },
  salesControlRequests_requestKey_unique: { msg: "طلب التحكم بفاتورة البيع مسجل مسبقاً — افتح الطلب القائم." },
  salesControlRequests_active_invoice_unique: { msg: "يوجد طلب تحكم معلّق لهذه الفاتورة — احسمه قبل إنشاء طلب آخر." },
  salesExchangeCommands_controlRequest_unique: { msg: "طلب التحكم نُفذ مسبقاً بأمر استبدال." },
  salesExchangeCommands_commandKey_unique: { msg: "أمر استبدال فاتورة البيع مسجل مسبقاً." },
  salesExchangeCommands_replacement_unique: { msg: "الفاتورة البديلة مرتبطة بأمر استبدال آخر." },
  ...
  uq_iism_item_material: {
    msg: "استهلاك هذه المادة مسجّل مسبقاً على بند الخدمة نفسه — حدّث الكمية المحفوظة بدل تكرار السطر.",
  },
  ...
  // اللقطة والاستعادة (م٦ ق٨، هجرة 0330):
  uniq_entity_version: { msg: "رقمُ إصدارٍ للكيان مُسجَّلٌ مسبقاً (سباقُ تعديلَين متزامنَين) — أعِد المحاولة، سيُخصَّص رقمٌ جديد تلقائياً." },
  // طلبات الحوكمة الموحّدة (م٧، هجرة 0331):
  uniq_active_control_request: { msg: "يوجد طلبُ حوكمةٍ نشطٌ على نفس القرار والكيان — انتظر قرارَه أو اسحبه إن كنتَ مُنشئه، ثم أعِد المحاولة." },
  ...
  uq_cash_daily_branch_date: { msg: "توجد مطابقة نقدية مسجّلة لهذا الفرع في يوم العمل نفسه — حدّث الشاشة وافتح المطابقة القائمة." },
  ...
  uq_cash_custody_count_request: { msg: "محاولة عدّ هذه العهدة مسجّلة مسبقاً — حدّث طابور الاستلام ولا تُعد إرسالها." },
  uq_cash_daily_request: { msg: "طلب عدّ الخزينة هذا مستعمل مسبقاً — حدّث المطابقة قبل إعادة المحاولة." },
  uq_cash_daily_close_request: { msg: "طلب إقفال المطابقة هذا مسجّل مسبقاً — حدّث الشاشة للتحقق من نتيجة الإقفال." },
  uq_cash_missed_daily_active_date: { msg: "يوجد طلب استثناء معلّق أو معتمد لهذا الفرع واليوم — افتح الطلب القائم ولا تنشئ مساراً موازياً." },
  uq_cash_missed_daily_request: { msg: "مفتاح طلب استثناء الجرد مستخدم مسبقاً — حدّث الشاشة للتحقق من نتيجة الطلب." },
  uq_cash_missed_daily_decision: { msg: "مفتاح قرار استثناء الجرد مستخدم مسبقاً — حدّث الشاشة للتحقق من نتيجة القرار." },
  uq_cash_missed_daily_event_request: { msg: "مفتاح حدث استثناء الجرد مستخدم مسبقاً — راجع سلسلة الأحداث ولا تكرر الحدث." },
  uq_cash_missed_daily_event_version: { msg: "تغيّر إصدار استثناء الجرد — حدّث الشاشة قبل اتخاذ القرار." },
  uq_cash_variance_proposal_request: { msg: "مفتاح اقتراح فرق النقد مستخدم مسبقاً — حدّث قائمة الحالات للتحقق من نتيجة الطلب." },
  uq_cash_variance_custody_count: { msg: "يوجد اقتراح تسوية لهذا العدّ المستقل بالفعل — افتح الحالة القائمة ولا تُنشئ اقتراحاً موازياً." },
  uq_cash_variance_daily_version: { msg: "يوجد اقتراح تسوية لهذه المطابقة وهذا الإصدار بالفعل — حدّث المطابقة وافتح الحالة القائمة." },
  uq_cash_variance_event_request: { msg: "مفتاح قرار فرق النقد مستخدم مسبقاً — حدّث الحالة للتحقق من نتيجة القرار." },
  uq_cash_variance_adjustment_receipt: { msg: "سند تعديل النقد مرتبط بحالة فرق نقد أخرى — راجع سجل الحالة ولا تُكرر السند." },
  uq_cash_variance_accounting_entry: { msg: "قيد تسوية النقد مرتبط بحالة فرق نقد أخرى — راجع دفتر القيود ولا تُكرر الترحيل." },
  uq_cash_variance_case_version: { msg: "تغيّر إصدار حالة فرق النقد — حدّث الشاشة قبل اعتماد القرار أو رفضه." },
  uq_cash_variance_advance: { msg: "ذمة الموظف مرتبطة بحالة فرق نقد أخرى — راجع القضية والقيد ولا تُكرر الاستحقاق." },
  uq_cash_variance_evidence_branch_hash: { msg: "ملف الدليل نفسه مسجل مسبقاً لهذا الفرع — افتح الدليل القائم ولا تُكرر رفعه." },
  uq_cash_variance_evidence_request: { msg: "مفتاح رفع دليل فرق النقد مستخدم مسبقاً — حدّث الحالة للتحقق من نتيجة الطلب." },
  ...
  tracking_ref_preflight_0358: { msg: "توجد بوالص شركة توصيل قديمة متكررة بعد توحيد صيغة الرقم — صحّح التكرار قبل متابعة ترقية قاعدة البيانات." },
  ...
  uq_consignment_party_tracking_ref: { msg: "رقم بوليصة شركة التوصيل مستخدم مسبقاً لدى الجهة نفسها — صحّح الرقم أو افتح الإرسالية السابقة." },
  ...
  uq_diir_intent_source_stock: {
    msg: "حجز المخزون لهذا السطر الرقمي مسجّل مسبقاً — استكمل النيّة القائمة ولا تُنشئ حجزاً مكرراً.",
  },
  uq_dsii_basket_owner_target: { msg: "تعذر ربط بطاقات السلة بعملية المزود — حدّث السلة وتحقق من رقم العملية." },
