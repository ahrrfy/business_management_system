...
export const WO_TIMELINE_LABEL: Record<string, string> = {
  ...
  // «استُرجع» لا «أُلغي»: الأمرُ وقع وسُلِّم فعلاً ثمّ عُكِس — والخطُّ الزمنيّ سجلُّ ما حدث،
  // فتسميتُه إلغاءً تمحو أنّ الزبون استلم العمل ثمّ ردّه.
  "workOrder.reverseDelivery": "استُرجع الأمر بعد التسليم",
  "workOrder.reverseServiceInvoice": "عُكس التسليم وأُرجعت الفاتورة",
  // ش٢/ش٣ (١٩/٨) — أفعالٌ جديدة. الحارسُ حمّرَ عليها فور إضافتها إلى الراوتر بلا اسم،
  // وهو بالضبط ما بُني له: قاموسٌ يقرأ من المصدر الحيّ لا من قائمةٍ تُكتب بيدٍ فتشيخ.
