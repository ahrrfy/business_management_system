...
export const PERMISSION_MODULES: PermissionModule[] = [
  ...
  // ⚠️ صدق التسمية (٢٥/٧): بوّابات أقسام نقطة البيع (POS_STATION_GATES) — كل وحدة تحكم **تبويباً بعينه**:
  // pos ⇐ «خدمات طباعة»، sales ⇐ «تجزئة»، workorders ⇐ «استقبال أوامر شغل». كانت الأسماء العامّة تُضلّل
