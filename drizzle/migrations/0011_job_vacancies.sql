...
ALTER TABLE `jobApplicants` ADD CONSTRAINT `jobApplicants_vacancyId_jobVacancies_id_fk` FOREIGN KEY (`vacancyId`) REFERENCES `jobVacancies`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE INDEX `idx_vacancy_published` ON `jobVacancies` (`isPublished`);
