-- بذر شجرة الحسابات لبيئة CI (db:push يُنشئ الجدول بلا بيانات الهجرة). نفس INSERT الهجرة 0115،
-- INSERT IGNORE (idempotent) + SET NAMES utf8mb4 (حماية العربية). الإنتاج يبذُر عبر الهجرة الحقيقية.
SET NAMES utf8mb4;
--> statement-breakpoint
INSERT IGNORE INTO `accounts` (`id`,`code`,`name`,`type`,`parentId`,`systemRole`,`sortOrder`) VALUES
