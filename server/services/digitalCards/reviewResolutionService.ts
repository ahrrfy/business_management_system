    ...
    if (!attempt || attempt.state !== "REVERSED") {
      throw new TRPCError({
        ...
        message: appErrorMessage({
          what: "تعذّر إلغاء نيّة البيع الرقمي",
          why: "قبضها الخارجي مؤكّد ولا يوجد إثبات أن مزوّد الدفع عكس العملية",
          doThis: "أبقها للمراجعة، أثبت العكس لدى المزوّد، ولا تمرّر البطاقة ثانيةً",
        }),
      });
    }
  }
