 ...
 * `effectiveTo`: الطرف المقابل (0205). كان إنهاءُ الخدمة يقطع الربط **فوراً**، وهو يقع
...
export async function mapDeviceUserToEmployee(
  ...
  return withTx(async (tx) => {
    ...
    // والحدُّ الأعلى `effectiveTo` **يُمسح في كل ربطٍ أو فكّ** بلا استثناء (0205): موظفٌ أُنهيت
