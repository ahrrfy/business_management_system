  ...
  capability?: typeof DIGITAL_SALE_CAPABILITY,
    ...
    if (
      ...
      throw new TRPCError({
        code: "CONFLICT",
        message: appErrorMessage({
          what: "تعذّر تثبيت مكوّنات البكج في الفاتورة",
          why: "تغيّر تعريف أحد البكجات أثناء حفظ البيع",
          doThis: "حدّث شاشة البيع وراجع البكج ثم أعد المحاولة",
        }),
      });
    }
    ...
    if (
      ...
      throw new TRPCError({
        code: "CONFLICT",
        message: appErrorMessage({
          what: "تعذّر تثبيت مواد الخدمة في الفاتورة",
          why: "تغيّرت وصفة مواد إحدى الخدمات أثناء حفظ البيع",
          doThis: "حدّث شاشة البيع وراجع الخدمة ثم أعد المحاولة",
        }),
      });
    }
