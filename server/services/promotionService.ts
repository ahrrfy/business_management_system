 ...
 *
 * وهي تشمل **كلّ** منتهي خدمةٍ له تاريخُ إنهاءٍ مضى، لا صاحبَ الإجراء الجاري وحده: من
 * أُنهيت خدمته من بطاقة الموظف (`employeeService`) كان ربطُه يبقى حيّاً إلى الأبد.
 * ومن أُنهي بلا تاريخٍ مسجَّل لا يُقطع ربطُه هنا — لا دليل على انتهاء يومه، وبصماتُه
 * تُركَن مرئيّةً في الطيّ بدل أن تُيتَّم.
 *
 * ⚠️ مُصدَّرة كي تُستدعى من مهمّةٍ يومية أيضاً: بلا ذلك تجري الكنسة عند إكمال إنهاءٍ
 * لاحقٍ فقط، فيطول بقاء ربطٍ مؤجَّل. (الوصل بمهمّة دورية خارج ملكية هذا الملف.)
 *
