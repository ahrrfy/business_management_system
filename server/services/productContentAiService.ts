...
inputName وinputDescription سياق صياغة أدخله الموظف: استفد من ألفاظهما لتحسين الصياغة، لكن لا تعتبر أي معلومة فيهما مواصفة مؤكدة إذا لم توجد في الحقول المنظمة.
