...
3. شغّل المرآة الباردة الأولية من جهاز/قرص مستقل (copy لا sync)، ثم verify وتمرين استعادة فعلي
   ...
   يدوياً أو مجلدين شقيقين على الجهاز نفسه: يجب أن تكون الوجهة على filesystem device مختلف، وأن
   يبقى الإيصال وملفات الوجهة متاحين للقراءة كي يعيد GC إثبات هوية الجهاز والبصمات ونطاق الـbucket.
