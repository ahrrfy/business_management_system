...
> عقد المصدر الحاليّ لإصدار الإشعارات v15 في ١/٩/٢٠٢٦ = **versionCode 15 · versionName 1.0.2**؛ الرقم 10 مستعمل، وأُلغيت مسودّة 11 قبل النشر لإزالة مكتبات native المجرّدة من الرموز جذرياً، واستهلك Play الرقمين 12 و13 عند رفع مسودّتي الاستبدال قبل النشر. أصلح v14 استبعاد TV/Car غير المقصود، ويضيف v15 قنوات الإشعارات الموجّهة والمنبثقة.
