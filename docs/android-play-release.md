...
> عقد المصدر الحاليّ لإصدار v14 في ٣١/٨/٢٠٢٦ = **versionCode 14 · versionName 1.0.2**؛ الرقم 10 مستعمل، وأُلغيت مسودّة 11 قبل النشر لإزالة مكتبات native المجرّدة من الرموز جذرياً، واستهلك Play الرقمين 12 و13 عند رفع مسودّتي الاستبدال قبل النشر. أصلح v14 استبعاد TV/Car غير المقصود بإعلان `android.hardware.screen.portrait` اختيارياً؛ نشاط ماسح ML Kit وحده عموديّ، لا التطبيق بأكمله.
