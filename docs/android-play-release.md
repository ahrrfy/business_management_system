...
> عقد المصدر الحاليّ لإصدار v13 في ٣٠/٨/٢٠٢٦ = **versionCode 13 · versionName 1.0.2**؛ الرقم 10 مستعمل، وأُلغيت مسودّة 11 قبل النشر لإزالة مكتبات native المجرّدة من الرموز جذرياً، واستهلك Play الرقم 12 عند رفع المسودّة البديلة قبل حفظها.
