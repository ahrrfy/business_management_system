...
|---|---|---|
| `LOCAL_GATE` | **163** (24%) | بوّابة مُعرَّفة **داخل ملف الراوتر** لا في `server/trpc.ts` ⇒ سلطة لامركزية. |
...
| `RAW_ROLE_GATE` | 58 | حكمٌ باسم الدور. |
...
### البوّابات اللامركزية (163 نقطة عبر 15 راوتراً)
...
ناقصة بمقدار الربع. هذا يفسّر لماذا تشترط §24.1 حصر AST وحارس CI.
