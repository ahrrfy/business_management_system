...
> **مرجع الحوكمة:** [`docs/authorization-governance-redesign-v2-2026-07-29-ar.md`](../authorization-governance-redesign-v2-2026-07-29-ar.md) (AGP-002 v2.0)
...
أداة **قراءة فقط** تمسح `server/` وتولّد `endpoint-inventory.csv/json`. لا تعدّل كوداً ولا سلوكاً.
الراية `--check` تجعلها حارساً (تفشل عند نقطة كتابة بلا بوّابة وحدة) — **لا تُربط بـCI قبل اعتماد الكتالوج** (§30.2).
...
| نقاط ببوّابة مُعرَّفة **خارج** `server/trpc.ts` | **163** (24%) |
