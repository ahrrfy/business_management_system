    ...
    <ScreenContainer className="flex-1" containerClassName="bg-background">
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        {requestNumber ? (
          ...
          <View style={styles.notice}><MaterialIcons color="#0C5A4B" name="info-outline" size={20} /><Text style={styles.noticeText}>لا يترتب على هذا الطلب دفع أو حجز أو سعر نهائي. يتم اعتماد العرض بعد التواصل معك فقط.</Text></View>
